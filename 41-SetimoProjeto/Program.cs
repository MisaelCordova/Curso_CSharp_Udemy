...
namespace _41_SetimoProjeto
{
    internal class Program
    {
        ...
        static string caminhoArquivo = @"baseDeDados.txt";
        ...
        public static Resultado_e CadastraUsuario(ref List<DadosCadastraisStruct> ListaDeUsuario)
        {
            ...
            GravaDados(caminhoArquivo, ListaDeUsuario);
        ...
        public static void GravaDados(string caminho, List<DadosCadastraisStruct> ListaDeUsuarios)
        {
            try
            {
                ...
                foreach (DadosCadastraisStruct cadastro in ListaDeUsuarios)
                {
                    ...
                    conteudoArquivo += tagDataNasc + cadastro.NumeroDoDocumento  + "\r\n";
        ...
        public static void BuscaUsuario(List<DadosCadastraisStruct> ListaDeUsuario)
        {
            ...
            {
                List<DadosCadastraisStruct> ListaDeUsuariosTemp = ListaDeUsuario.Where(x => x.NumeroDoDocumento == temp).ToList();
                if (ListaDeUsuariosTemp.Count > 0)
                {
                    foreach(DadosCadastraisStruct usuario in ListaDeUsuariosTemp)
                    {
                        ...
                        Console.WriteLine(tagDataNasc + usuario.DataDeNasc.ToString("dd/MM/yyyy"));
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Pressione B buscar um usuário");
